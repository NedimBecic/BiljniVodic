...
class ZemljisniTipChoiceAdapter(context: Context,
                                private val values: Array<Zemljiste>) : ArrayAdapter<Zemljiste>(context, -1, values) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        checkedTextView.text = item?.naziv
