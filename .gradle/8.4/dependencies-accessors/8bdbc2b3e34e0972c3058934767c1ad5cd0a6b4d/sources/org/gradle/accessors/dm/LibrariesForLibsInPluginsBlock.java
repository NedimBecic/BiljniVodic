...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        private final AndroidxMacroVersionAccessors vaccForAndroidxMacroVersionAccessors = new AndroidxMacroVersionAccessors(providers, config);
        public AndroidxVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of versions at versions.androidx.macro
         */
        public AndroidxMacroVersionAccessors getMacro() {
            return vaccForAndroidxMacroVersionAccessors;
        }

    }

    public static class AndroidxMacroVersionAccessors extends VersionFactory  {

        public AndroidxMacroVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: androidx.macro.benchmark (1.2.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getBenchmark() { return getVersion("androidx.macro.benchmark"); }
